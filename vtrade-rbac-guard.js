...
(() => {
  ...
  function installAdminPhoneBar(){
    ...
    const menu=document.createElement('div');menu.id='vtradePhoneMenuV91';menu.innerHTML=`<a href="dashboard.html?from=admin-terminal&v=20260820-phone-v91">▣ &nbsp; Live Terminal</a><a href="dashboard.html?from=admin-terminal&v=20260820-phone-v91#signals">◈ &nbsp; Signals</a><a href="dashboard.html?from=admin-terminal&v=20260820-phone-v91#ai">✦ &nbsp; AI</a><a href="profile.html">◉ &nbsp; ${km?'គណនី':'Profile'}</a><button id="v91Refresh">↻ &nbsp; ${km?'ផ្ទុកឡើងវិញ':'Refresh'}</button><button class="danger" id="v91Logout">↪ &nbsp; ${km?'ចាកចេញ':'Sign out'}</button>`;document.body.appendChild(menu);
    ...
    bar.querySelector('#v91Tf').onchange=e=>location.href=`dashboard.html?from=admin-terminal&tf=${encodeURIComponent(e.target.value)}&v=20260820-phone-v91`;
  }
